...
contract StemRootchain {
    ...
    /** events */
     ...
     event printNum(uint256 num);
     event printBytes32(bytes32 by32);
     event printAddress(address ad);
    ...
    */
     ...
     */
     function submitBlock(uint256 _blkNum, bytes32 _balanceTreeRoot, bytes32 _txTreeRoot, address[] _accounts, uint256[] _updatedBalances, uint256 _fee) public payable onlyOwner onlyWithValue(data.blockSubmissionBond) {//production environment: onlyOperator onlyWithValue(data.blockSubmissionBond) {
    ...
    */
    ...
    /**
     */
    function getLastConfirmedChildBlockNumber() public view returns(uint256){
      return data.getLastConfirmedChildBlockNumber();
    }
    ...
    function getOps() public view returns(address[]) {
       return data.operatorIndices;
    }
    ...
    function isLastChildBlockConfirmed() public view returns(bool) {
       return data.isLastChildBlockConfirmed();
    }
