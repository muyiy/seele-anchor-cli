...
library StemCreation {
    ...
    * @dev Initialize the contract parameters
    ...
    function init(StemCore.ChainStorage storage self) internal {
        ...
        self.childBlockChallengeSubmissionPeriod = 1 seconds;//12 hours;
        self.childBlockChallengePeriod = 2 seconds;//1 days;
        self.relayTimeout = 3 seconds
        // self.relayTimeout = 4 hours;
